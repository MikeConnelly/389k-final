...
dotenv.config();
mongoose.connect(`mongodb://Mike389k:${process.env.MONGOPASS}@cluster0-shard-00-00-hfvx4.mongodb.net:27017,cluster0-shard-00-01-hfvx4.mongodb.net:27017,cluster0-shard-00-02-hfvx4.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority`, {
